...
ALTER TABLE Integrantes ADD CONSTRAINT FK_INTEGRANTES FOREING KEY (Torneos_id) REFERENCES Torneos(Id_);
ALTER TABLE Integrantes ADD CONSTRAINT FK_INTEGRANTECLUB FOREING KEY (Clubes_Nombre) REFERENCES Clubes(Nombre);
ALTER TABLE Integrantes ADD CONSTRAINT FK_INTEGRANTESELECCION FOREING KEY (Selecciones_Nombre) REFERENCES Selecciones(Nombre);
ALTER TABLE Grupos ADD CONSTRAINT FK_GRUPOS FOREING KEY (Torneos_id) REFERENCES Torneos(Id_);
ALTER TABLE Ligas ADD CONSTRAINT FK_LIGAS FOREING KEY (Torneos_id) REFERENCES Torneos(Id_);
ALTER TABLE EstadisticasExtra ADD CONSTRAINT FK_ESTADISTICASEXTRA FOREING KEY (Torneos_id) REFERENCES Torneos(Id_);
ALTER TABLE TorneosConfederacion ADD CONSTRAINT FK_TORNEOCONFEDERACION FOREING KEY (Torneos_id) REFERENCES Torneos(Id_);
ALTER TABLE TorneosConfederacion ADD CONSTRAINT FK_TORNEOCONFEDERACION2 FOREING KEY (Confederaciones_Siglas) REFERENCES Confederaciones(Siglas);
ALTER TABLE PartidosConsultados ADD CONSTRAINT FK_PARTIDOSCONSULTADO FOREING KEY (Partidos_id) REFERENCES Partidos(Id_);
ALTER TABLE PartidosConsultados ADD CONSTRAINT FK_USUARIOSCONSULTA FOREING KEY (Usuarios_id) REFERENCES Usuarios(Id_);
ALTER TABLE Clubes ADD CONSTRAINT FK_CLUBESTADISTICA FOREING KEY (Clubes_Nombre) REFERENCES Clubes(Nombre);
ALTER TABLE Selecciones ADD CONSTRAINT FK_SELECCIONESCONFEDERACION FOREING KEY (Confederaciones_Siglas) REFERENCES Confederaciones(Siglas);
ALTER TABLE Selecciones ADD CONSTRAINT FK_SELECCIONESESTADIO FOREING KEY (Estadios_Nombre) REFERENCES Estadios(Nombre);
ALTER TABLE Clubes ADD CONSTRAINT FK_CLUBESESTADIO FOREING KEY (Estadio_Nombre) REFERENCES Estadio(Nombre);
ALTER TABLE Partidos ADD CONSTRAINT FK_PARTIDOSESTADIO FOREING KEY (Estadio_Nombre) REFERENCES Estadio(Nombre);
ALTER TABLE Sugerencias ADD CONSTRAINT FK_SUGERECIAPARTIDO FOREING KEY (Partidos_id) REFERENCES Partidos(Id_);
ALTER TABLE EstadisticasJugadores ADD CONSTRAINT FK_ESTADISTICASJUGADOR FOREING KEY (Jugadores_id) REFERENCES Jugadores(Id_);
ALTER TABLE EstadisticasClubes ADD CONSTRAINT FK_ESTADISTICACLUB FOREING KEY (Clubes_Nombre) REFERENCES Clubes(Nombre);
ALTER TABLE EstadisticasSelecciones ADD CONSTRAINT FK_ESTADISTICASELECCION FOREING KEY (Selecciones_Nombre) REFERENCES Selecciones(Nombre);
ALTER TABLE Jugadores ADD CONSTRAINT FK_JUGADORCLUB FOREING KEY (Clubes_Nombre) REFERENCES Clubes(Nombre);
ALTER TABLE Jugadores ADD CONSTRAINT FK_JUGADORSELECCION FOREING KEY (Selecciones_Nombre) REFERENCES Selecciones(Nombre);
ALTER TABLE Titulos ADD CONSTRAINT FK_TITULOSJUGADOR FOREING KEY (Jugadores_id) REFERENCES Jugadores(Id_);
ALTER TABLE Titulos ADD CONSTRAINT FK_TITULOSCLUB FOREING KEY (Clubes_Nombre) REFERENCES Clubes(Nombre);
ALTER TABLE Titulos ADD CONSTRAINT FK_TITULOSSELECCION FOREING KEY (Selecciones_Nombre) REFERENCES Selecciones(Nombre);
ALTER TABLE Empresas ADD CONSTRAINT FK_EMPRESASUSUARIO FOREING KEY (Usuarios_id) REFERENCES Usuarios(Id_);
ALTER TABLE Periodistas ADD CONSTRAINT FK_PERIODISRAEMPRESAS FOREING KEY (Periodistas_Usuarios_id) REFERENCES Periodistas(Usuarios_id_);
ALTER TABLE PersonasNaturales ADD CONSTRAINT FK_PERSONAUSUARIO FOREING KEY (Usuarios_id) REFERENCES Usuarios(Id_);
