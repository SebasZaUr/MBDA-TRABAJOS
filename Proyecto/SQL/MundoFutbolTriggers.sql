...
BEGIN
    ...
    IF auxiliar LIKE 'Seleccion' THEN 
...
ALTER TABLE Periodistas ADD CONSTRAINT AC_EMPRESAS FOREIGN KEY (FK_PERIODISTASEMPRESAS) REFERENCES Empresas(Usuario_id) ON DELETE CASCADE;
/*XTriggers*/
